                                              ...
                                              setState(() {
                                                ...
                                                if (mciSelectionStatus[
                                                    ...
                                                    mciSelectionStatus[
                                                        ...
                                                        .isEmpty) {
                                                  print(
                                                      "📱❌ $macAddress no pertenece a ningún grupo");

                                                  // Deseleccionamos todos los dispositivos si hay alguno seleccionado
                                                  if (isSelected
                                                      .containsValue(true)) {
                                                    isSelected
                                                        .forEach((key, value) {
                                                      if (value == true) {
                                                        ...
                                                        print(
                                                            "✖️ El dispositivo $key ha sido deseleccionado.");
                                                      }
                                                    });
                                                  }
                                                  ...
                                                  selectedKey =
                                                      macAddress; // Asignar la clave única
                                                  print(
                                                      "📱 $macAddress ha sido seleccionado.");
                                                  print(
                                                      "🔑 Clave asignada (dispositivo individual): $selectedKey");
                                                  mciEquipmentMap[macAddress] =
                                                      {}; // Mapa vacío para equipo
                                                }

                                                // Caso 2: Dispositivo con grupo
                                                else {
                                                  String? group =
                                                      mciSelectionStatus[
                                                          macAddress];
                                                  print(
                                                      "📱 $macAddress pertenece al grupo: $group");

                                                  // Agrupamos dispositivos por grupo
                                                  Map<String, List<String>>
                                                      groupedDevices = {};

                                                  mciSelectionStatus.forEach(
                                                      (deviceMac, group) {
                                                    if (group != null &&
                                                        group.isNotEmpty) {
                                                      groupedDevices
                                                  ...
                                                  if (group != null &&
                                                    ...
                                                    // Seleccionamos todos los dispositivos del grupo
                                                    groupedDevices[group]!
                                                        .forEach((deviceMac) {
                                                      isSelected[deviceMac] =
                                                          true;
                                                      print(
                                                          "📱 $deviceMac del grupo $group ha sido seleccionado.");
                                                    });
                                                    ...
                                                    String grupoKey =
                                                        groupedDevices[group]!
                                                            .join('-');
                                                    selectedKey =
                                                        grupoKey; // Asignar la clave del grupo
                                                    print(
                                                        "🔑 Clave asignada (grupo): $selectedKey");

                                                    // Asignamos un mapa vacío de equipos para el grupo
                                                    groupedDevices[group]!
                                                        .forEach((deviceMac) {
                                                      mciEquipmentMap[
                                                              deviceMac] =
                                                          {}; // Asignar un mapa vacío de equipos
                                                    });
                                                  }
                                                }
                                              });
                                                    ...
                                                    painter: NeonBorderPainter(
                                                      neonColor: _getBorderColor(
                                                          deviceConnectionStatus[
                                                              macAddress]),
                                                      opacity: _getOpacityForDevice(
                                                          macAddress), // Llamamos a una función que determina la opacidad
                                                    ),
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        ...
                                                        boxShadow: [
                                                          BoxShadow(
                                                            color: Colors.black
                                                                .withOpacity(
                                                                    _getOpacityForDevice(macAddress) ==
                                                                            1.0
                                                                        ? 0.3
                                                                        : 0.1),
                                                            // Menos opacidad si no está seleccionado
                                                            blurRadius: 10,
                                                            offset:
                                                                const Offset(
                                                                    0, 4),
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                selectedIndivProgram?[
                                                                    ...
                                                                    (allIndividualPrograms
                                                                            .isNotEmpty
                                                                        ? (allIndividualPrograms[0]['nombre']?.toUpperCase() ??
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                selectedRecoProgram?[
                                                                    ...
                                                                    (allRecoveryPrograms
                                                                            .isNotEmpty
                                                                        ? (allRecoveryPrograms[0]['nombre']?.toUpperCase() ??
                                                                            tr(context, 'NOMBRE PROGRAMA')
                                                                                .toUpperCase())
                                                                        : tr(context,
                                                                                'No hay programas disponibles')
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                selectedAutoProgram?[
                                                                    ...
                                                                    (allAutomaticPrograms
                                                                            .isNotEmpty
                                                                        ? (allAutomaticPrograms[0]['nombre_programa_automatico']?.toUpperCase() ??
                                                                            tr(context, 'NOMBRE PROGRAMA')
                                                                                .toUpperCase())
                                                                        : tr(context,
                                                                                'No hay programas disponibles')
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return Opacity(
                                                                                ...
                                                                                child: Image.asset(
                                                                                  ...
                                                                                  height: _isFullScreen ? screenHeight * 0.65 : screenHeight * 0.4,
                                                                                  fit: BoxFit.cover,
                                                                                ),
                                                                              );
                                                                            },
                                                                      ...
                                                                      children: [
                                                                        CustomPaint(
                                                                          size:
                                                                            ...
                                                                            _isFullScreen
                                                                                ? screenHeight * 0.03
                                                                                : screenHeight * 0.02, // Aumentar tamaño si isFullScreen es verdadero
                                                                          ),
                                                                          painter:
                                                                              LinePainter(
                                                                            progress2:
                                                                        ...
                                                                        SizedBox(
                                                                          width: _isFullScreen
                                                                              ? screenWidth * 0.01
                                                                              : screenWidth * 0.01, // Aumentar el espacio si isFullScreen es verdadero
                                                                        ),
                                                                        Text(
                                                                          valueContraction.toString().padLeft(
                                                                              1,
                                                                              '0'),
                                                                          style:
                                                                              TextStyle(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        CustomPaint(
                                                                          size:
                                                                            ...
                                                                            _isFullScreen
                                                                                ? screenHeight * 0.05
                                                                                : screenHeight * 0.05, // Aumentar tamaño si isFullScreen es verdadero
                                                                          ),
                                                                          painter:
                                                                            ...
                                                                            textStyle:
                                                                                TextStyle(
                                                                              fontSize: _isFullScreen ? 23.sp : 18.sp,
                                                                              // Aumentar tamaño de fuente si isFullScreen es verdadero
                                                                              fontWeight: FontWeight.bold,
                                                                  ...
                                                                  onTap: selectedKey ==
                                                                      ...
                                                                      : () {
                                                                          setState(
                                                                            ...
                                                                            for (int i = 0;
                                                                                i < _isMusculoTrajeBloqueado.length;
                                                                                i++) {
                                                                              if (!_isMusculoTrajeBloqueado[i] && !_isMusculoTrajeInactivo[i]) {
                                                                  ...
                                                                  onTap: selectedKey ==
                                                                      ...
                                                                      : () {
                                                                          setState(
                                                                            ...
                                                                            isSessionStarted =
                                                                                !isSessionStarted;
                                                                            debugPrint('isSessionStarted: $isSessionStarted');
                                                                          });
                                                                        },
                                                                  child:
                                                                      SizedBox(
                                                                  ...
                                                                  onTap: selectedKey ==
                                                                      ...
                                                                      : () {
                                                                          setState(
                                                                            ...
                                                                            for (int i = 0;
                                                                                i < _isMusculoPantalonBloqueado.length;
                                                                                i++) {
                                                                              if (!_isMusculoPantalonBloqueado[i] && !_isMusculoPantalonInactivo[i]) {
                                                                      ...
                                                                      children: [
                                                                        buildControlRow(
                                                                          ...
                                                                          onIncrement:
                                                                              () {
                                                                            setState(() {
                                                                              valueContraction += 1.0; // Lógica de incremento
                                                                            });
                                                                          },
                                                                          onDecrement:
                                                                              () {
                                                                            setState(() {
                                                                              if (valueContraction > 0) {
                                                                                valueContraction -= 1.0; // Lógica de decremento
                                                                              }
                                                                            });
                                                                          },
                                                                          suffix:
                                                                        ...
                                                                        buildControlRow(
                                                                          ...
                                                                          onIncrement:
                                                                              () {
                                                                            setState(() {
                                                                              valuePause += 1.0; // Lógica de incremento
                                                                            });
                                                                          },
                                                                          onDecrement:
                                                                              () {
                                                                            setState(() {
                                                                              if (valuePause > 0) {
                                                                                valuePause -= 1.0; // Lógica de decremento
                                                                              }
                                                                            });
                                                                          },
                                                                          suffix:
                                                                        ...
                                                                        buildControlRow(
                                                                          ...
                                                                          onIncrement:
                                                                              () {
                                                                            setState(() {
                                                                              valueRampa += 1.0; // Lógica de incremento
                                                                            });
                                                                          },
                                                                          onDecrement:
                                                                              () {
                                                                            setState(() {
                                                                              if (valueRampa > 0) {
                                                                                valueRampa -= 1.0; // Lógica de decremento
                                                                              }
                                                                            });
                                                                          },
                                                                          suffix:
