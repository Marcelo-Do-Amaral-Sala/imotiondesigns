    ...
    setState(() {
      ...
      _timer = Timer.periodic(Duration(seconds: 1), (timer) {
        setState(() {
          ...
          int minutesPassed = (elapsedTime / 60)
              .floor(); // Obtener los minutos transcurridos
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(
                        vertical: _isFullScreen ? 50.0 : 5.0,
                        horizontal: _isFullScreen ? 30.0 : 0.0),
                    child: Row(
                      children: [
                        Expanded(
              ...
              Column(
                children: [
                  GestureDetector(
                    ...
                    child: SizedBox(
                      width: _isFullScreen ? 90.0 : 70.0,
                      height: _isFullScreen ? 90.0 : 70.0,
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.asset(
                          // Lógica de selección de la imagen
                  ...
                  Text(
                    '${porcentajesMusculoPantalon[index]}%',
                    style: TextStyle(
                      fontSize: _isFullScreen ? 16.0 : 13,
                      fontWeight: FontWeight.bold,
