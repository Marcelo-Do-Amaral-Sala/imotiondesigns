                                  ...
                                  children: [
                                    if (isSessionStarted) ...[
                                      _buildMuscleRow(
                                        ...
                                        imagePathInactive: 'assets/images/pec_gris.png',
                                      ),
                                      ...
                                      _buildMuscleRow(
                                        ...
                                        imagePathInactive: 'assets/images/biceps_gris.png',
                                      ),
                                      SizedBox(height: screenHeight * 0.005),
                                      _buildMuscleRow(
                                        index: 2,
                                        ...
                                        imagePathInactive: 'assets/images/abs_gris.png',
                                      ),
                                      SizedBox(height: screenHeight * 0.005),
                                      _buildMuscleRow(
                                        index: 3,
                                        ...
                                        imagePathInactive: 'assets/images/cua_gris.png',
                                      ),
                                      SizedBox(height: screenHeight * 0.005),
                                      _buildMuscleRow(
                                        index: 4,
                                        ...
                                        imagePathInactive: 'assets/images/gemelos_gris.png',
                                      ),
                                    ] else
                                      if (!isSessionStarted) ...[
                                        _buildMuscleRow(
                                  ...
                                  children: [
                                    if (isSessionStarted) ...[
                                      _buildMuscleRow(
                                        ...
                                        imagePathInactive: 'assets/images/trap_gris.png',
                                      ),
                                      SizedBox(height: screenHeight * 0.005),
                                      _buildMuscleRow(
                                        index: 6,
                                        ...
                                        imagePathInactive: 'assets/images/dorsal_gris.png',
                                      ),
                                      SizedBox(height: screenHeight * 0.005),
                                      _buildMuscleRow(
                                        index: 7,
                                        ...
                                        imagePathInactive: 'assets/images/lumbar_gris.png',
                                      ),
                                      SizedBox(height: screenHeight * 0.005),
                                      _buildMuscleRow(
                                        index: 8,
                                        ...
                                        imagePathInactive: 'assets/images/gluteo_gris.png',
                                      ),
                                      SizedBox(height: screenHeight * 0.005),
                                      _buildMuscleRow(
                                        index: 9,
                                        ...
                                        imagePathInactive: 'assets/images/isquio_gris.png',
                                      ),
                                    ] else
                                      if (!isSessionStarted) ...[
                                        _buildMuscleRow(
      ...
      children: [
        Container(
          color: _isMusculoTrajeInactivo[index] // Si está inactivo, color gris
              ...
              : _isMusculoTrajeBloqueado[index] // Si está bloqueado, color naranja
              ...
              Column(
                children: [
                  GestureDetector(
                    ...
                    onLongPress: () {
                      setState(() {
                        // Cambia el estado de actividad (por ejemplo, activar o desactivar el grupo muscular)
                        _isMusculoTrajeInactivo[index] =
                        !_isMusculoTrajeInactivo[index];
                      });
                    },
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          ...
                          _isMusculoTrajeBloqueado[index]
                              ...
                              : (_isMusculoTrajeInactivo[index] // Si está inactivo
