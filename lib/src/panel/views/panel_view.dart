                              ...
                              child: IndexedStack(
                                ...
                                children: AppState.instance.mcis.map((mci) {
                                  ...
                                  return ExpandedContentWidget(
                                    ...
                                    index: index,
                                    macAddress: macAddress, onToggleOverlay: toggleOverlay
                                  );
                                }).toList(),
                              ),
                            ),
...
class ExpandedContentWidget extends StatefulWidget {
  ...
  final Function(int) onToggleOverlay;

  ExpandedContentWidget(
      {required this.index, required this.macAddress, this.selectedKey, required this.onToggleOverlay});
                          ...
                          children: [
                            ...
                            Expanded(
                              child: GestureDetector(
                                ...
                                child: Opacity(
                                  opacity:
                                      widget.selectedKey == null ? 1.0 : 1.0,
                                  // Indicación visual
                                  child: AnimatedScale(
                            ...
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTapUp: widget.selectedKey == null
                                    ? null
                                    : (_) =>
                                        setState(() => scaleFactorRepeat = 1.0),
                                onTap: widget.selectedKey == null
                                    ? null
                                    : () {
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: GestureDetector(
                                    onTapDown: (_) =>
                                        setState(() => scaleFactorReset = 0.90),
                                    onTapUp: (_) =>
                                        setState(() => scaleFactorReset = 1.0),
                                    onTap: () {
