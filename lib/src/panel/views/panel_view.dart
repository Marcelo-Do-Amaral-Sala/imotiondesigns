...
class _ExpandedContentWidgetState extends State<ExpandedContentWidget>
  ...
  Future<bool> startFullElectrostimulationTrajeProcess(
    ...
    try {
      ...
      final isElectroOn =
          await bleConnectionService.startElectrostimulationSession(
        widget.macAddress!,
        valoresCanalesTraje,
        frecuencia,
        rampa,
      ...
      final response = await bleConnectionService.controlAllChannels(
        widget.macAddress!,
        1, // Endpoint
        0, // Modo
        valoresCanalesTraje,
...
// Debug: Mostrar los valores asignados
      ...
      if (isElectroOn) {
        ...
        Map<String, dynamic> response =
            await bleConnectionService.controlAllChannels(
          widget.macAddress!,
          1,
          0,
          valoresCanalesPantalon,
