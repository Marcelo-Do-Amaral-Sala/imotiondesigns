...
class DatabaseHelperPrograms {
  static final DatabaseHelperPrograms _instance = DatabaseHelperPrograms._internal();
  static Database? _database;

  factory DatabaseHelperPrograms() {
    return _instance;
  }

  DatabaseHelperPrograms._internal();
