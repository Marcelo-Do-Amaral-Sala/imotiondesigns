...
class EntrenadoresTableWidget extends StatefulWidget {
  ...
  const EntrenadoresTableWidget({super.key, required this.data, required this.onRowTap});

  @override
  _EntrenadoresTableWidgetState createState() => _EntrenadoresTableWidgetState();
}

class _EntrenadoresTableWidgetState extends State<EntrenadoresTableWidget> {
  @override
