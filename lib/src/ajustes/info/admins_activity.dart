...
class AdminsActivity extends StatefulWidget {
  ...
  const AdminsActivity({
    super.key,
    required this.adminDataActivity,
  });

  @override
  _AdminsActivityState createState() => _AdminsActivityState();
}

class _AdminsActivityState extends State<AdminsActivity> {
  ...
  void initState() {
    super.initState();
    _indexController.text = widget.adminDataActivity['id'] ?? '';
    _nameController.text = widget.adminDataActivity['name'] ?? '';
    selectedOption = widget.adminDataActivity['status'];
  }
